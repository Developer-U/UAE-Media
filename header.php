...
<body <?php body_class(); ?> <?php echo blocksy_body_attr() ?>>
	...
	<header class="header">
		<div class="header__wrapper">
			<div class="container">
				<div class="header__top header-top header-top d-flex justify-content-between">
					...
					<div class="header-top__right d-flex flex-column justify-content-between">
						...
						<ul class="header__icons icons d-grid">								
							<li>
		...
		<div class="header__wrapper">
			<div class="container">
				<div class="header__bottom header-bottom d-grid align-items-center justify-content-between">
					<button class="header__burger burger" aria-label="Открыть меню" data-popup-open="burger_menu">
