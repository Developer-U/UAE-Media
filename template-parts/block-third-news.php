...
/**
 * Block third news
 * Третий блок - первая новость крупная картинка, далее - списком
 */

$third_news_cat = get_field('third_news_cat_' . get_locale() . '', 'options');
...
if ($third_news_cat) {
    ...
    <section class="block third pink">
        <div class="container">
            ...
            $cat = get_category($third_news_cat);
            ...
            <div class="swiper third__slider third-slider d-block d-sm-none">
