			...
			<section class="footer dark">
				<div class="container">
					<div class="footer-wrapper d-grid align-items-start">
                        ...
                        <ul class="footer-list__cats footer-cat-list d-flex justify-content-between">
                            <?php 
                            $arg_cat = array(
                                'orderby'      => 'name',
                                'order'        => 'ASC',
                            ...
                            if( $categories ){
                                foreach( $categories as $cat ){
                                    ...
                                    <li class="footer-cat-list footer-cat-item">
                                        <h3 class="footer-cat-item__title">
                                            <?php echo $cat->name; ?>
                                        </h3>
                        ...
                        <div class="footer-list last d-flex gap-4 d-lg-block">
                            <h3 class="footer-cat-item__title col-auto">
                                News
                            </h3>
                            <h3 class="footer-cat-item__title col-auto">
                                Category
...
<section class="mega-menu" data-popup="burger_menu">
    <button class="mega-menu__close" aria-label="Закрыть меню" data-popup-close="burger_menu">
        <svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.66117 19.8388L19.3388 2.16113M19.3388 19.8388L1.66113 2.16117" stroke="#222222" stroke-width="3" stroke-linecap="round"/>
        </svg>
    </button>
